...
MOCK_ISSUES: tuple[Issue, ...] = (
    ...
    Issue(
        ...
        events=(
            ...
            IssueEvent(dt("2026-04-24T15:01:00"), "In Progress", "Testing", "Ilya Romanov"),
            IssueEvent(dt("2026-04-24T15:40:00"), "Testing", "Done", "Ilya Romanov"),
        ),
    ),
    Issue(
        key="API-917",
        summary="Fix typo in partner webhook alert",
        project="API",
        assignee="Polina Vetrova",
        priority="Low",
        story_points=1,
        created_at=dt("2026-04-24T14:32:00"),
        events=(
            IssueEvent(dt("2026-04-24T14:42:00"), "To Do", "In Progress", "Polina Vetrova"),
            IssueEvent(dt("2026-04-24T14:58:00"), "In Progress", "Testing", "Ilya Romanov"),
            IssueEvent(dt("2026-04-24T15:07:00"), "Testing", "Done", "Ilya Romanov"),
        ),
    ),
    Issue(
        key="API-919",
        summary="Patch rate limit hint text in integration logs",
        project="API",
        assignee="Polina Vetrova",
        priority="Low",
        story_points=1,
        created_at=dt("2026-04-24T14:40:00"),
        events=(
            IssueEvent(dt("2026-04-24T14:48:00"), "To Do", "In Progress", "Polina Vetrova"),
            IssueEvent(dt("2026-04-24T15:14:00"), "In Progress", "Testing", "Ilya Romanov"),
            IssueEvent(dt("2026-04-24T15:23:00"), "Testing", "Done", "Ilya Romanov"),
        ),
    ),
    Issue(
        key="API-920",
        summary="Adjust webhook debug payload truncation",
        project="API",
        assignee="Polina Vetrova",
        priority="Medium",
        story_points=2,
        created_at=dt("2026-04-24T14:46:00"),
        events=(
            IssueEvent(dt("2026-04-24T14:55:00"), "To Do", "In Progress", "Polina Vetrova"),
            IssueEvent(dt("2026-04-24T15:15:00"), "In Progress", "Testing", "Ilya Romanov"),
            IssueEvent(dt("2026-04-24T15:36:00"), "Testing", "Done", "Ilya Romanov"),
        ),
    ),
    Issue(
        key="UI-1207",
    ...
    Issue(
        key="UI-1212",
        summary="Fix hover state on compact kanban cards",
        project="UI",
        assignee="Sofia Mironova",
        priority="Low",
        story_points=1,
        created_at=dt("2026-04-24T13:05:00"),
        events=(
            IssueEvent(dt("2026-04-24T13:08:00"), "To Do", "In Progress", "Sofia Mironova"),
            IssueEvent(dt("2026-04-24T13:24:00"), "In Progress", "Testing", "Nikita Vibecoder"),
            IssueEvent(dt("2026-04-24T13:31:00"), "Testing", "Done", "Nikita Vibecoder"),
        ),
    ),
    Issue(
        key="UI-1213",
        summary="Refine sidebar scroll shadows on mobile",
        project="UI",
        assignee="Sofia Mironova",
        priority="Medium",
        story_points=2,
        created_at=dt("2026-04-24T13:06:00"),
        events=(
            IssueEvent(dt("2026-04-24T13:09:00"), "To Do", "In Progress", "Sofia Mironova"),
            IssueEvent(dt("2026-04-24T13:25:00"), "In Progress", "Testing", "Nikita Vibecoder"),
            IssueEvent(dt("2026-04-24T13:49:00"), "Testing", "Done", "Nikita Vibecoder"),
        ),
    ),
    Issue(
        key="CORE-1855",
    ...
    Issue(
        key="CORE-1858",
        summary="Correct audit row ordering in retry monitor",
        project="CORE",
        assignee="Oleg Smirnov",
        priority="Low",
        story_points=1,
        created_at=dt("2026-04-24T16:00:00"),
        events=(
            IssueEvent(dt("2026-04-24T16:05:00"), "To Do", "In Progress", "Oleg Smirnov"),
            IssueEvent(dt("2026-04-24T16:27:00"), "In Progress", "Testing", "Mila Sidorova"),
            IssueEvent(dt("2026-04-24T16:36:00"), "Testing", "Done", "Mila Sidorova"),
        ),
    ),
    Issue(
        key="CORE-1859",
        summary="Trim noisy retry metrics labels",
        project="CORE",
        assignee="Oleg Smirnov",
        priority="Medium",
        story_points=2,
        created_at=dt("2026-04-24T16:02:00"),
        events=(
            IssueEvent(dt("2026-04-24T16:06:00"), "To Do", "In Progress", "Oleg Smirnov"),
            IssueEvent(dt("2026-04-24T16:28:00"), "In Progress", "Testing", "Mila Sidorova"),
            IssueEvent(dt("2026-04-24T17:05:00"), "Testing", "Blocked", "Mila Sidorova"),
        ),
    ),
)
